...
10          continue
  ...
  !-----------------------------------------------------------------------------------------------------
       ...
       atm2lnd_vars%forc_hgt_u_grc(g) = 10.0 !atm2lnd_vars%forc_hgt_grc(g)    !observational height of wind [m]
       atm2lnd_vars%forc_hgt_t_grc(g) = 2.0 !atm2lnd_vars%forc_hgt_grc(g)    !observational height of temperature [m]
       atm2lnd_vars%forc_hgt_q_grc(g) = 2.0 !atm2lnd_vars%forc_hgt_grc(g)    !observational height of humidity [m]
